        ...
        <div id="mainNav" class="hidden md:flex items-center gap-4 md:gap-6 mx-auto order-2 flex-wrap">
          ...
          <div class="relative group">
            ...
            <div class="dropdownMenu hidden absolute left-0 mt-2 w-40 bg-white rounded-md shadow-lg ring-1 ring-black/10 z-50">
              <a href="events.html" class="dropdown-item block px-4 py-2 md:text-base lg:text-lg text-gray-700 hover:bg-cyan-100 text-base">活動消息</a>
              <a href="news.html" class="dropdown-item block px-4 py-2 md:text-base lg:text-lg text-gray-700 hover:bg-cyan-100 text-base">最新活動</a>
            </div>
          </div>
		  
          <!--<a href="epaper.html" class="nav-link md:text-base lg:text-lg text-white hover:bg-cyan-600 px-3 py-2 rounded-md font-medium transition">電子報</a>-->
    ...
    <div id="mobile-menu" class="md:hidden hidden bg-cyan-600">
      <div class="px-4 pt-2 pb-4 space-y-1">
		...
		<div class="m-sub-menu hidden ml-3 mt-1 space-y-1">
		  <a href="events.html" class="dropdown-item block text-white/90 text-lg hover:bg-cyan-700 px-3 py-2 rounded-md">活動消息</a>
		  <a href="news.html" class="dropdown-item block text-white/90 text-lg hover:bg-cyan-700 px-3 py-2 rounded-md">最新活動</a>
		</div>
		
        <a href="result.html" class="nav-link block text-white text-lg hover:bg-cyan-700 px-3 py-2 rounded-md">執行成果</a>
